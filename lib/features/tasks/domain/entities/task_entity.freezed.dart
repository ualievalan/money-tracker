...
class _$TaskEntityImpl implements _TaskEntity {
  ...
  @override
  String toString() {
    return 'TaskEntity(id: $id, title: $title, isDone: $isDone, deadline: $deadline, priority: $priority, reminderAt: $reminderAt, repeat: $repeat)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, isDone, deadline, priority, reminderAt, repeat);
...
abstract class _TaskEntity implements TaskEntity {
  const factory _TaskEntity(
      ...
      final TaskPriority priority,
      final DateTime? reminderAt,
      final TaskRepeat repeat}) = _$TaskEntityImpl;
